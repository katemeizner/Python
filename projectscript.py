...
#lets ask requests to get that page
	...
	url = "http://www.cagematch.net/?id=112&view=search&sEventName=WCW%20Monday%20Nitro&sEventType=TV-Show&sDateFromDay=04&sDateFromMonth=09&sDateFromYear=1995&sDateTillDay=26&sDateTillMonth=03&sDateTillYear=2001&sPromotion=2&sRegion=Amerika&sWorkerRelationship=Any&s=" + str(total_pages)
	print(url)
...
with open('scraped_matchdata.json', 'w') as f:
